...
const databaseTesting = "examen_grupo_tap_testing";

function crearSchema() {
  const colecciones = db.getCollectionNames();

  if (!colecciones.includes("producto")) {
  ...
  if (!colecciones.includes("usuario")) {
  ...
  if (!colecciones.includes("perfil")) {
  ...
  if (!colecciones.includes("seccion")) {
  ...
  if (!colecciones.includes("bitacora")) {
